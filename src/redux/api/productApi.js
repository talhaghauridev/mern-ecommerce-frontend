...
export const productApi = createApi({
   ...
   endpoints: (builder) => ({
      getProduct: builder.query({
         query: ({ keyword = "", page = 1, price = FILTER_PRICE, category, ratings = null }) => {
      ...
      createProduct: builder.mutation({
         ...
         invalidatesTags: [{ type: "product", id: "all" }, { type: "adminProducts" }]
      }),
      ...
      updateProduct: builder.mutation({
         ...
         invalidatesTags: (result, error, { id }) => [{ type: "product", id }, { type: "adminProducts" }]
      }),
