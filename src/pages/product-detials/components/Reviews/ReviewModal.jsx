...
const ReviewModal = ({ openModal = false, setOpenModal }) => {
   const { handelChange, review, handleSubmitReview, isLoading, data, isSuccess } = useCreateReview();
   ...
   return (
      <div className={cn("h-[100vh] fixed w-full z-10 transition-all", openModal ? "flex" : "hidden")}>
         <BackDrop
            isOpen={openModal}
