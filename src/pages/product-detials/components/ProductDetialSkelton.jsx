   ...
   return (
      <div className="container py-[50px] md:py-[80px] grid grid-cols-1 md:grid-cols-2 items-center justify-center gap-[30px]">
         <div className="flex items-center justify-start  md:justify-center w-full h-full">
            <Skeleton
               variant="rectangular"
               className={"w-full max-w-[300px] md:max-w-[500px] h-[300px!important] sm:h-[330px!important] object-contain"}
            />
         </div>
         ...
         <div className=" flex flex-col gap-[10px] mt-[20px] ">
            <div className="flex flex-col gap-[20px]">
               <Skeleton
                  variant="rectangular"
                  className=" w-[100%] max-w-[245px] h-[36px!important] text-gray-500"></Skeleton>
               <Skeleton
                  variant="text"
                  className=" w-[100%] h-[35px!important] max-w-[220px] text-gray-500"></Skeleton>
            </div>
