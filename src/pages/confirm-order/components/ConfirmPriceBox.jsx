...
const ConfirmOrderBox = () => {
   const { handleSendPayment, isLoading, shippingCharges, subTotal, tax, totalPrice } = useSendPayment();
   return (
      <div
         ...
         <div className="py-[40px] px-[30px] flex flex-col gap-y-[25px] md:gap-y-[40px]">
            <div className="flex flex-col gap-y-[14px]">
               <h1 className="font-bold text-[26px] text-gray-800 relative font-Sans text-center mb-[12px]">Order Summary</h1>
            ...
            <Button
               ...
               disabled={isLoading}
               className={`max-w-full flex items-center justify-center ${isLoading && "opacity-[0.7]"} `}>
