...
const useUpdateUser = () => {
   ...
   const { isLoading: detialLoading, data: detialData } = useGetSingleUserQuery(userId);

   const [updateUser, { isLoading: updateLoading, isSuccess, data, error }] = useUpdateUserMutation();

   const initialValues = useMemo(() => getDetails(detialData), [useId, detialData]);
