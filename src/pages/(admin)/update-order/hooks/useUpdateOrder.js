...
const useUpdateOrder = () => {
   ...
   const { isLoading: orderDetialLoading, data } = useGetOrderDetailsQuery(orderId);
   const [updateOrder, { isError, isLoading, error, data: updateOrderData }] = useUpdateOrderMutation();
   ...
   const orderStatus = useMemo(() => (order?.orderStatus === "Delivered" ? true : false), [order]);
