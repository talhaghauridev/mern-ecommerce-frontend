            ...
            <div className="flex flex-col ">
               ...
               <div className="flex flex-col gap-[20px] py-[20px] ">
                  ...
                  <ul className="flex flex-col gap-[15px] items-start justify-center]">
                     ...
                     <li className={cn(`order_li`)}>
                        <h2>Order Status:</h2>
                        <span className={cn(order?.orderStatus === "Processing" ? "processing" : "success")}>{order?.orderStatus}</span>
                     </li>
                  </ul>
               </div>
               ...
               <div className="flex flex-col gap-[20px] py-[20px] ">
                  <div className="confirm_heading flex gap-[8px] ">
                     ...
                     <li className="order_li ">
                        <b className="items-center justify-start font-Poppins mt-[2px] text-[15px] "> {formatDate(order?.createdAt)}</b>
                     </li>
                  </div>
               </div>
