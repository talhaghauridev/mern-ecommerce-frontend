...
const QuantityInput = ({ className = "", value = 0, increment, decrement }) => {
   return (
      <div className={cn("w-full flex items-center justify-center max-w-fit", className)}>
         <QuantityButton
            onClick={increment}
            icon={FaPlus}
         />

         <span className="px-[13px] h-full font-PoppinsBold text-[20px] flex items-center justify-center">{value}</span>
