...
const ProductSkeleton = () => {
   return (
      <div
         className="flex items-center justify-start flex-col relative overflow-hidden gap-[6px] bg-white rounded-md shadow-md pb-[5px] max-w-[300px] h-[350px] w-full  m-auto"
         style={{
