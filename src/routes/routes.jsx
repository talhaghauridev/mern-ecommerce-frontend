...
const ForgotPassword = lazyWithProgress(() => import("@/pages/(authentication)/password-forgot"));
const ResetPassword = lazyWithProgress(() => import("@/pages/(authentication)/password-reset"));
const SignUp = lazyWithProgress(() => import("@/pages/(authentication)/signup"));
